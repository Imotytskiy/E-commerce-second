...
//           <div className="flex items-center gap-1 mt-2">{/* for stars */}</div>
...
const Product = () => {
  ...
  return productData ? (
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
            ...
            <div className="flex gap-2">
              {productData.sizes.map((item, index) => (
                <button
                  ...
                  key={index} // Correct placement of key
                >
                  {item}
                </button>
              ))}
      ...
      {/* desription and reviev section */}
      <div className="mt-20">
        <div className="flex">
          <b className="border px-5 py-3 text-sm">Descripttion</b>
          <p className="border px-5 py-3 text-sm">Revievs (122)</p>
        </div>
